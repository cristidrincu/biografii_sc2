...
class CI_Email {
	...
	var	$smtp_host		= "s21.rohost.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "warbringer@starcraft2-vidcasts.ro";		// SMTP Username
	var	$smtp_pass		= "crusader22012";		// SMTP Password
