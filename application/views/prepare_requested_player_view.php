...
<div class='span9 reportsOperationsArea'>
    ...
    <div class='span7 offset1'>
        ...
        $input_field_name=array('name'=>'requested_player_name','id'=>'playerRequestName','class'=>'input-large');
        $input_field_nickname=array('name'=>'requested_player_nickname','id'=>'playerNickname','class'=>'input-large');
        ...
        $drop_down_race=array('Terran'=>'Terran', 'Zerg'=>'Zerg', 'Protoss'=>'Protoss');
        $drop_down_id = 'id="selectRace"';

        $submit_btn_attributes=array('name'=>'submitBtn','class' => 'btn', 'type'=>'submit','content'=>'Creaza Request');

        //display form
        echo form_open_multipart('index.php/requested_player/create_requested_player', $form_attributes);
        ?>
        ...
        <div class="control-group">
            <label class="control-label" for="selectRace">Rasa</label>
            <div class="controls">
                <?php echo form_dropdown('requested_player_race',$drop_down_race,'',$drop_down_id); //name = player_team?>
            </div>
        </div>
        <div class="control-group">
