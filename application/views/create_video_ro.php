<div class='row-fluid mainContentContainer'>
        ...
        <div class='CRUDMainMenu'>
            ...
            <div class="accordion" id="accordion3">
                ...
                <div class="accordion-group">
                    ...
                    <div id="collapseFourRo" class="accordion-body collapse in">
                        <div class="accordion-inner">
    ...
    <div class='span9 reportsOperationsArea'>
        ...
        <div class='span7 offset1'>
            <h3 style='padding-bottom:15px; text-align:center'>CREEAZA UN NOU CLIP <?php echo $page_title; ?></h3>
            <?php
            ...
            $input_field_name=array('name'=>'video_name','id'=>'videoName','class'=>'input-large');
            $input_field_link=array('name'=>'video_link','id'=>'videoLink','class'=>'input-large');



            $submit_btn_attributes=array('name'=>'submitBtn','class' => 'btn', 'type'=>'submit','content'=>'Creeaza Clip Video');
            ?>

            <?php
            echo form_open('index.php/video_ro/create_video_ro', $form_attributes);
            ?>
