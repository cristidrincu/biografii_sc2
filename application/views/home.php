...
Sunt foarte încântat ca sunt inclus în proiectul VGN iar Starcraft 2 face parte din viața mea. De asemenea,sunt fidel GSL-ului unde fiecare meci e un spectacol, o lecție, o încântare. Îmi doresc să alcătuim o echipă puternică și o comunitate bazată pe respect.</p>
                     ...
                     <div class="containerDeveloper">
                        ...
                        <div class="containerTextDeveloper">
                           ...
                           <p>Salut. Numele meu este Cristian Drincu a.k.a. Warbringer. Am 29 de ani si sunt din Timisoara. Radacinile de gamer le-am prins din clasa a 5-a, cand am primit primul comp, un 486. Primul joc a fost “Dune”, apoi “Warcraft”. Cam astea doua jocuri got me hooked forever pe stilul RTS.

Am hotarat sa ma implic in acest proiect pentru a oferi comunitatii romanesti de Starcraft2 un loc in care se pot documenta despre cei mai buni jucatori de SC2 din lume!</p>
                        </div>
                        <br class="clearFloats"/>
                    </div>
                </div>
                <div class="span4">
                    <a href="http://www.starcraft2-vidcasts.ro" target="_blank"><img id="logoSC2VidcastsLarge" src="<?php echo base_url(); ?>imgs/logo.png" alt="Starcraft2 Vidcasts Romania"/></a>
                </div>
            </div><!--ends row-->
            </div>
