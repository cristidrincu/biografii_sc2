                ...
                <div class="span3 sidebarMenu">
                    <div class="sidebarContainer">
                        <div class="terranContainerImage">
                              ...
                              <div class="containerScurtaDescriereTerran">
                                   ...
                                   <a href='<?php echo base_url(); ?>main/terran_players' class='btn btn-primary'>Afiseaza</a>
                               </div>
                    ...
                    <div class="terranContainerImage">                               
                               <div class="containerScurtaDescriereTerran">
                                   ...
                                   <br class="clearFloats"/>
                                   <a href='<?php echo base_url(); ?>main/zerg_players' class='btn btn-primary'>Afiseaza</a>
                               </div>    
                    ...
                    <div class="terranContainerImage">
                               <div class="containerScurtaDescriereTerran">
                                   ...
                                   <br class="clearFloats"/>
                                   <a href='<?php echo base_url(); ?>main/protoss_players' class='btn btn-primary'>Afiseaza</a>
                               </div>
                    </div><!--ends terranContainerImage-->   
                    </div>   
                </div>
                <div class="span9">
                    <div class="sectionDescription containerEntities">
                        ...
                        <div class="btn-toolbar containerLetters">
                            <div class="btn-group">
                                <?php echo anchor('main/find_player/A/Protoss', 'A', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipA')); ?>
                                <?php echo anchor('main/find_player/B/Protoss', 'B', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipB')); ?>
                                <?php echo anchor('main/find_player/C/Protoss', 'C', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipC')); ?>
                                <?php echo anchor('main/find_player/D/Protoss', 'D', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipD')); ?>
                                <?php echo anchor('main/find_player/E/Protoss', 'E', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipE')); ?>
                                <?php echo anchor('main/find_player/F/Protoss', 'F', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipF')); ?>
                                <?php echo anchor('main/find_player/G/Protoss', 'G', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipG')); ?>
                                <?php echo anchor('main/find_player/H/Protoss', 'H', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipH')); ?>
                                <?php echo anchor('main/find_player/I/Protoss', 'I', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipI')); ?>
                                <?php echo anchor('main/find_player/J/Protoss', 'J', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipJ')); ?>
                                <?php echo anchor('main/find_player/K/Protoss', 'K', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipK')); ?>
                                <?php echo anchor('main/find_player/L/Protoss', 'L', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipL')); ?>
                                <?php echo anchor('main/find_player/M/Protoss', 'M', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipM')); ?>
                                <?php echo anchor('main/find_player/N/Protoss', 'N', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipN')); ?>
                                <?php echo anchor('main/find_player/O/Protoss', 'O', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipO')); ?>
                                <?php echo anchor('main/find_player/P/Protoss', 'P', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipP')); ?>
                                <?php echo anchor('main/find_player/Q/Protoss', 'Q', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipQ')); ?>
                                <?php echo anchor('main/find_player/R/Protoss', 'R', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipR')); ?>
                                <?php echo anchor('main/find_player/S/Protoss', 'S', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipS')); ?>
                                <?php echo anchor('main/find_player/T/Protoss', 'T', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipT')); ?>
                                <?php echo anchor('main/find_player/U/Protoss', 'U', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipU')); ?>
                                <?php echo anchor('main/find_player/V/Protoss', 'V', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipV')); ?>
                                <?php echo anchor('main/find_player/W/Protoss', 'W', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipW')); ?>
                                <?php echo anchor('main/find_player/X/Protoss', 'X', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipX')); ?>
                                <?php echo anchor('main/find_player/Y/Protoss', 'Y', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipY')); ?>
                                <?php echo anchor('main/find_player/Z/Protoss', 'Z', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipZ')); ?>
                            </div>
                        </div>
                    ...
                    <div class="latestPlayersAddedContainer">
                        ...
                        <?php foreach($results_all_protoss as $protoss): ?>
                            <div class="span3 playerContainerSmall">
                                ...
                                <?php echo anchor("main/getPlayerDetails/$protoss->player_ID","Citeste intreaga biografie",array('class'=>'btn btn-success')); ?>
                            </div>
                        <?php endforeach; ?>
                        <?php break; ?>
                        <?php case 2: ?>
