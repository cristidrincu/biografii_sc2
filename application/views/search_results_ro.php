        ...
        <div class="span9">
            <div class="sectionDescription containerEntities">
                ...
                <div class="input-append">
                    <?php
                    echo form_open('index.php/search_ro/displayResults', $form_attributes);
            ...
            <div class="latestPlayersAddedContainer">
                ...
                <div class="span3 playerContainerSmall">
                    ...
                    <?php echo anchor("index.php/main/getPlayerDetailsRO/$result->player_ID/$result->nickname","Citeste intreaga biografie",array('class'=>'btn btn-success')); ?>
                </div>
                <?php endforeach; ?>
