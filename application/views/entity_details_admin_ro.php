            ...
            <?php case 4: ?>
                ...
                <?php foreach($video_details as $video): ?>
                    <tr>
                        ...
                        <td><?php echo anchor('index.php/video/prepare_update_video_ro/'.$video->video_id, 'Update', array("class"=>"btn btn-primary")); ?></td>
                        <td><?php echo anchor('index.php/video/prepare_delete_video_ro/'.$video->video_id, 'Delete', array("class"=>"btn btn-danger")); ?></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
                <?php break; ?>
