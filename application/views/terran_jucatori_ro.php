        ...
        <div class="span9">
            <div class="sectionDescription containerEntities">
                ...
                <div class="btn-toolbar">
                    <div class="btn-group">
                        <?php echo anchor('index.php/main/find_player_RO/A/Terran', 'A', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipA')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/B/Terran', 'B', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipB')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/C/Terran', 'C', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipC')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/D/Terran', 'D', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipD')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/E/Terran', 'E', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipE')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/F/Terran', 'F', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipF')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/G/Terran', 'G', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipG')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/H/Terran', 'H', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipH')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/I/Terran', 'I', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipI')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/J/Terran', 'J', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipJ')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/K/Terran', 'K', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipK')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/L/Terran', 'L', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipL')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/M/Terran', 'M', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipM')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/N/Terran', 'N', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipN')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/O/Terran', 'O', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipO')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/P/Terran', 'P', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipP')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/Q/Terran', 'Q', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipQ')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/R/Terran', 'R', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipR')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/S/Terran', 'S', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipS')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/T/Terran', 'T', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipT')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/U/Terran', 'U', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipU')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/V/Terran', 'V', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipV')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/W/Terran', 'W', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipW')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/X/Terran', 'X', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipX')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/Y/Terran', 'Y', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipY')); ?>
                        <?php echo anchor('index.php/main/find_player_RO/Z/Terran', 'Z', array('class' => 'btn', 'data-toggle'=>'tooltip', 'rel'=>'tooltipZ')); ?>
                    </div>
                </div>
                ...
                <?php switch($display_results):
                    case 1:
                        ...
                        <div class="span3 playerContainerSmall">
                            ...
                            <?php echo anchor("index.php/main/getPlayerDetailsRO/$terran->player_ID/$terran->race/$terran->nickname","Citeste intreaga biografie",array('class'=>'btn btn-success')); ?>
                        </div>
                    <?php endforeach; ?>
                        <?php break; ?>
                    <?php case 2: ?>
