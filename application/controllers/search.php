...
class Search extends CI_Controller{
    ...
    public function load_results_page_backend_player($search_keyword, $entity_type){

        $this->setPageTitle('Rezultate cautare dupa jucator');

        $data['player_entity']=$this->m_search_entities->player_backend_results($search_keyword);
	...
	public function get_player_backend(){
	...
	public function get_title_backend(){
	...
	public function get_video_backend(){

		$this->setEntityType(4);
        $data['video_entity']=$this->m_search_entities->video_backend_results($this->input->post('search_field'));
